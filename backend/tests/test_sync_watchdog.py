...
class TestAdaptiveWatchdog:
    ...
    async def test_stall_detection_cancels_sync(self):
        ...
        async def stalling_precache(artists, albums, status_service, resume=False, *, initiating_user_id=None):
    ...
    async def test_progressing_sync_completes(self):
        ...
        async def fast_precache(artists, albums, status_service, resume=False, *, initiating_user_id=None):
    ...
    async def test_max_timeout_cancels_even_with_progress(self):
        ...
        async def slow_but_progressing(artists, albums, status_service, resume=False, *, initiating_user_id=None):
    ...
    async def test_error_in_precache_propagates(self):
        ...
        async def failing_precache(artists, albums, status_service, resume=False, *, initiating_user_id=None):
