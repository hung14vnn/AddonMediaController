<script lang="ts">
	...
	$effect(() => {
		// Release notes are only useful while the modal is eligible to open. Keep
		// the markdown parser and sanitizer off the startup path for dismissed or
	...
	>
		...
		>
			...
			<div class="modal-action mt-6 gap-3">
				...
				<button
					class="btn btn-accent btn-sm px-6 shadow-sm shadow-accent/15"
