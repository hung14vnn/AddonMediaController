		...
		<div class="form-control">
			...
			<span class="label">
				<span class="label-text-alt">
					Run Test to load categories. A dedicated <code>Addonifyusic</code> category gives
		...
		<section class="space-y-2">
			...
			<div class="space-y-1.5 rounded-box border border-base-content/10 bg-base-200/40 p-3">
				...
				<p class="text-xs text-base-content/60">
					Where Addonify sees SABnzbd's completed folder (its <code>complete</code> dir),
